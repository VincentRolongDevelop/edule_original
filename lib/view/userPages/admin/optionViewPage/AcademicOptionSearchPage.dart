...
import 'package:flutter_application_1/view/userPages/admin/components/tables/AcademicTable.dart';


class AcademicOptionSearchPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Search View Academic'),
          leading: IconButton(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              AcademicTable(), // Agrega la tabla aquí
            ],
          ),
        ),
      ),
