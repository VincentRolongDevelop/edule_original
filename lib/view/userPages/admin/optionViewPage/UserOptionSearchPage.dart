...
import 'package:flutter_application_1/view/userPages/admin/components/tables/AdminTable.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

class UserOptionSearchPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text('Search View Student'),
          leading: IconButton(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              AdminTable(), // Agrega la tabla aquí
            ],
          ),
        ),
      ),
